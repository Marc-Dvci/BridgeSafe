// Package main runs the bridgesafe-extension end-to-end test:
...
import (
	...
	"bridgesafe-extension/tools/pkg/configs"
	"bridgesafe-extension/tools/pkg/fccutils"
	"bridgesafe-extension/tools/pkg/support"
	instrutils "bridgesafe-extension/tools/pkg/utils"
